 ...
 */
package de.htwg.mdsd.playmorphiamodelling.services;
...
@Singleton
public class PlayMorphiaModellingGrammarAccess extends AbstractGrammarElementFinder {
	
	public class DomainmodelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling.Domainmodel");
	...
	public class PackageDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling.PackageDeclaration");
	...
	public class AbstractElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling.AbstractElement");
	...
	public class MorphiaModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling.MorphiaModel");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AttributeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling.Attribute");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling.Type");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class DataTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling.DataType");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ImportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling.Import");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class QualifiedNameWithWildcardElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling.QualifiedNameWithWildcard");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class QualifiedNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling.QualifiedName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	@Inject
	public PlayMorphiaModellingGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.htwg.mdsd.playmorphiamodelling.PlayMorphiaModelling".equals(grammar.getName())) {
				return grammar;
			}
